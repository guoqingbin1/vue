...
// 登录接口 
export const login = (params) => { return loginreq("post", "/api/user_admin/login", params) };
// 获取用户菜单
export const menu = (params) => { return req("post", "/api/user_admin/getMenu", params) };
// 退出接口
export const loginout = (params) => { return loginreq("post", "/api/user_admin/loginout", params) };
 
/**
 * 用户管理 
 **/
// 用户管理-获取用户列表
export const userList = (params) => { return req("post", "/api/user_admin/list", params) };
// 用户管理-保存（添加编辑）
export const userSave = (params) => { return req("post", "/api/user_admin/save", params) };
// 用户管理-删除用户
...
// 用户管理-重置密码
export const userPwd = (params) => { return req("post", "/api/user_admin/resetPwd", params) };
// 用户管理-修改状态
export const userLock = (params) => { return req("post","/api/user_admin/lock" , params) };
// 用户管理-重置密码
export const userResetPwd = (params) => { return req("post","/api/user_admin/resetPwd" , params) };
// 用户管理-数据权限
